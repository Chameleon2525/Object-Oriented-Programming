...
#ifndef _EasyBMP_Font_h_
#define _EasyBMP_Font_h_
                  ...
                  RGBApixel Color )
{
 int CharNumber = 0;
 int StartX = TopLeftX;
 int Spacing = (int) Round( 0.2*Height );
 if( Spacing < 3 )
 { Spacing = 3; }
...
// { Letter = toupper(Letter); }
 ...
 if( Letter == 'a'  )
 {
  ...
  int x2 = Round(TopLeftX+0.5*Height);
  int y2 = Round(TopLeftY+0.5*Height);
  ...
  return Round( TopLeftX + 0.5*Height );
 }
 ...
 if( Letter == 'b' )
 {
  ...
  int x2 = TopLeftX; // Round(TopLeftX+0.5*Height);
  int y2 = TopLeftY; // Round(TopLeftY+0.5*Height);
 ...
 if( Letter == 'e' )
 {
  ...
  int x2 = TopLeftX;
  int y2 = Round(TopLeftY + 0.75*Height);
  
  int x3 = Round( TopLeftX+0.5*Height);
  int y3 = y2;
 ...
 if( Letter == 'f' )
 {
  int x1 = Round( TopLeftX + 0.25*Height);
  ...
  int x3 = TopLeftX;
  int y3 = Round( TopLeftY + 0.5*Height);
 ...
 if( Letter == 'g' )
 {
  ...
  int x3 = x2;
  int y3 = Round(TopLeftY+1.25*Height);
 ...
 if( Letter == 'h' )
 {
  ...
  int x3 = TopLeftX;
  int y3 = TopLeftY; // Round(TopLeftY+0.5*Height);
  
  int x4 = x3;
  int y4 = TopLeftY + Height;
  
  int x5 = Round(TopLeftX+0.5*Height);
  int y5 = Round(TopLeftY+0.75*Height);
 ...
 {
  int x1 = TopLeftX;
  int y1 = Round(TopLeftY+0.5*Height);
 ...
 if( Letter == 'j' )
 {
  ...
  int x2 = x1;
  int y2 = Round(TopLeftY+1.25*Height);
 ...
 if( Letter == 'k' )
 {
  ...
  int x3 = x1;
  int y3 = Round(TopLeftY+0.75*Height);
  
  int x4 = Round(TopLeftX+0.3*Height);
  int y4 = Round(TopLeftY+0.5*Height);
 ...
 if( Letter == 'p' )
 {
  ...
  int x3 = x2;
  int y3 = Round(TopLeftY + 1.5*Height);
 ...
 if( Letter == 'q' )
 {
  ...
  int x4 = Round(x3+0.2*Height);
  int y4 = Round(y3-0.2*Height);
...
//  DrawLine(Image,x5,y5,x6,y6,Color);
 ...
 if( Letter == 's' )
 {
  ...
  return Round(TopLeftX+2*difference);
 }
 ...
 if( Letter == 'u' )
 {
  ...
  int x4 = x3;
  int y4 = Round(TopLeftY+0.75*Height);//  + Height;
  
  int x5 = Round(TopLeftX+0.5*Height);
  int y5 = TopLeftY + Height;// Round(TopLeftY+0.75*Height);
 ...
 if( Letter == 'v' )
 {
  ...
  int x2 = Round( TopLeftX+0.2*Height);
  int y2 = TopLeftY+Height;
  
  int x3 = Round( TopLeftX+0.4*Height);
  int y3 = y1;
 ...
 if( Letter == 'y' )
 {
  ...
  int x3 = Round(x1+0.25*Height);
  int y3 = TopLeftY+Height;
  
  int x4 = x1;
  int y4 = Round(TopLeftY+1.25*Height)+1;
 ...
 if( Letter == 'A' )
 {
  ...
  int x2 = TopLeftX + Round( 0.3*Height );
  int y2 = TopLeftY;
  
  int x3 = TopLeftX + Round( 0.6*Height );
  int y3 = y1;
  
  int x4 = TopLeftX + Round( 0.1*Height );
  int y4 = Round( y1 - Height/3.0 );
  
  int x5 = Round( x3 - 0.1*Height ); 
  int y5 = y4;
 ...
 if( Letter == 'B' )
 {
  ...
  int x3 = TopLeftX + Center; // (int) Round( 0.3*Height );
  int y3 = TopLeftY;
  
  int x4 = x1;
  int y4 = (int) Round( TopLeftY + 0.5*Height );
  ...
  return Round( TopLeftX + Center + 0.25*Height); 
 }
 ...
 if( Letter == 'C' )
 {
  ...
  return TopLeftX + Width; //  Round(TopLeftX+0.6*Height);
 } 
 ...
 if( Letter == 'D' )
 {
  ...
  int x2 = TopLeftX + Center; // Round( TopLeftX + 0.3*Height );
  int y2 = y1;
  ...
  int x7 = TopLeftX + Width; // Round(TopLeftX + 0.6*Height);
  int y7 = (int) y5; // Round( y5 );
  
  int x8 = x7;
  int y8 = (int) y6; //  Round( y6 );
 ...
 if( Letter == 'E' )
 {
  ...
  int x5 = Round( TopLeftX + 0.45*Height);
  int y5 = y4;
 ...
 if( Letter == 'F' )
 {
  ...
  int x5 = Round( TopLeftX + 0.45*Height); // x3;
  int y5 = y4;
 ...
 if( Letter == 'G' )
 {
  ...
  int x9 = TopLeftX + Center; // Round( TopLeftX + 0.45*Height );
  int y9 = Round( TopLeftY + 0.6*Height );
  
  int x10 = TopLeftX + Width; // Round( TopLeftX + 0.65*Height );
  int y10 = y9;
  ...
  return x10; //  Round(TopLeftX+0.6*Height);
 }  
 ...
 if( Letter == 'H' )
 {
  ...
  int x5 = x1;
  int y5 = Round( TopLeftY + 0.5*Height );
 ...
 if( Letter == 'I' )
 {
  int x1 = Round( TopLeftX + Height*0.05);
  int y1 = TopLeftY;
  
  int x2 = Round(x1 + 0.4*Height);
  int y2 = y1;
  
  int x3 = Round( x1 + 0.2*Height);
  int y3 = y1;
 ...
 if( Letter == 'K' )
 {
  ...
  int x3 = x1;
  int y3 = TopLeftY + Height - Center; // Round( TopLeftY + 0.6*Height );
 ...
 if( Letter == 'R' )
 {
  ...
  int x9 = Round( TopLeftX + 0.25*Height);
  int y9 = y4;  
 ...
 if( Letter == 'W' )
 {
  ...
  int x2 = Round(TopLeftX + 0.4*Height);
  int y2 = y1;
  
  int x3 = Round( TopLeftX + 0.8*Height);
  int y3 = y1;
  
  int x4 = Round( TopLeftX + 0.2*Height );
  int y4 = TopLeftY + Height;
  
  int x5 = Round( TopLeftX + 0.6*Height );
  int y5 = y4;
 ...
 if( Letter == '1' )
 {
  ...
  int x5 = Round(x1 + 0.05*Height);
  int y5 = Round(TopLeftY+ 0.2*Height);
  
  DrawLine( Image , x1, y1, x2, y2, Color );
  DrawLine( Image , x3, y3, x4, y4, Color );
  DrawLine( Image , x4, y4, x5, y5, Color );
  
  return Round(x2 + Height*0.05);
 } 
 
 if( Letter == '2' )
 {
  int x1 = TopLeftX + Width; // Round( TopLeftX + 0.6*Height );
  int y1 = TopLeftY+Height;
  ...
  int x3 = x1;
  int y3 = TopLeftY + Center; // Round( TopLeftY + 0.3*Height )+1;
 ...
 if( Letter == '3' )
 {
  ...
  int x3 = Round( TopLeftX + 0.3*Height);
  int y3 = Round( TopLeftY + 0.5*Height);
 ...
 if( Letter == '4' )
 {
  ...
  int x1 = TopLeftX+Width;
  int y1 = TopLeftY+Round(Height*2.0/3.0);
 ...
 if( Letter == '5' )
 {
  ...
  int x3 = TopLeftX + Round( 0.2*Height )-1;
  int y3 = TopLeftY + Round( 0.48786796564404*Height );
 ...
 if( Letter == '6' )
 {
  ...
  return TopLeftX + (int) Round(.5*Height); 
 } 
 ...
 if( Letter == '7' )
 {
  ...
  int x3 = Round(TopLeftX + 0.1*Height);
  int y3 = TopLeftY + Height;
 ...
 if( Letter == '[' )
 {
  ...
  int x3 = Round(TopLeftX + 0.15*Height)+1;
  int y3 = y1;
 ...
 if( Letter == '-' )
 {
  int TempWidth = Round(0.5*Height);
  if( TempWidth % 2 != 0 )
  { TempWidth++; }
 ...
 if( Letter == '?' )
 {
  ...
  int x3 = x2;
  int y3 = Round(TopLeftY+ 0.8*Height);
 ...
 if( Letter == '*' )
 {
  ...
  int x5 = TopLeftX+1; // Round(TopLeftX+0.15*Width);
  int y5 = TopLeftY+1; // Round(TopLeftY+0.15*Height);
  
  int x6 = TopLeftX+Width-1; // Round(TopLeftX+0.45*Width);
  int y6 = TopLeftY+Height-1; //  Round(TopLeftY+0.85*Height);
 ...
 if( Letter == '@' )
 {
  ...
  return Round(TopLeftX + 3*Center);
 }
 ...
 if( Letter == '~' )
 {
  ...
  return Round(TopLeftX + 0.8*Height);
 }
 ...
 if( Letter == '&' )
 {
  ...
  int x5 = Round(TopLeftX+0.25*Height);
  int y5 = TopLeftY+Height-2*Center;
  
  int x6 = Round(TopLeftX+1.1*Width);
  int y6 = TopLeftY+Height;  
...
//  DrawLine( Image, x3,y3, x4,y4, Color);
 ...
 if( Letter == '&' && 1 == 0 ) // alt ampersand &
 {
  ...
  int x5 = Round(TopLeftX+0.1*Height);
  int y5 = y3;
 ...
 if( Letter == '$' )
 {
  ...
  int x3 = Round(x1);
  int y3 = Round(TopLeftY-0.1*Height);
  
  int x4 = x3;
  int y4 = Round(TopLeftY+1.1*Height);
 ...
 if( Letter ==  '}' )
 {
  ...
  int x5 = Round( TopLeftX+0.2*Height);
  int y5 = Round( TopLeftY+0.15*Height);
  
  int x6 = x5;
  int y6 = Round( TopLeftY+0.4*Height);
  
  DrawLine( Image, x5,y5, x6,y6, Color );

  int x7 = x5;
  int y7 = Round( TopLeftY+0.6*Height);
  
  int x8 = x7;
  int y8 = Round( TopLeftY+0.85*Height);
  
  DrawLine( Image, x7,y7, x8,y8, Color );  

  return Round(TopLeftX + 0.4*Height);
 }
 ...
 if( Letter == '&' && 1 == 0 ) // old ampersand '&'
 {
  ...
  int x5 = Round(TopLeftX + 0.35*Height);
  int y5 = Round(TopLeftY + 0.75*Height);
  
  int x6 = Round(TopLeftX + 0.65*Height);
  int y6 = y5;
                  ...
                  RGBApixel Color )
{
 ...
 int CharNumber = 0;
 int StartX = Round(TopLeftX+0.25*Height);
 int Spacing = (int) Round( 0.2*Height );
 if( Spacing < 3 )
 { Spacing = 3; }
 int StartY = Round( TopLeftY-0.25*Height);
